...
Page({
        ...
        wx.uploadFile({
            ...
            success: function(e) {
                "" != e.data ? (console.log(e), o++, imgArray.push(e.data), a.setData({
                    imgArray: imgArray,
                    lunbo_len: imgArray.length
                }), console.log(t), console.log("上传厂家轮播图时候提交的图片数组", imgArray)) : wx.showToast({
                    icon: "loading",
                    title: "请重试"
                });
            },
        ...
        wx.uploadFile({
            ...
            success: function(e) {
                "" != e.data ? (console.log(e), o++, uploaded.push(e.data), a.setData({
                    uploaded: uploaded,
                    upload_img_length: uploaded.length
                }), console.log(t), console.log("上传厂家介绍时候提交的图片数组", uploaded)) : wx.showToast({
                    icon: "loading",
                    title: "请重试"
                });
            },
    ...
    formSubmit: function(e) {
        ...
        var P = "";
        if ("" == u ? P = "请输入厂家名称" : "" == r ? P = "请输入关键字" : "" == d ? P = "请输入详细地址" : "" == f ? P = "请输入联系电话" : "00:00" == g ? P = "请输入营业开始时间" : "00:00" == p ? P = "请输入营业结束时间" : "" == h ? P = "请输入公告说明" : 0 == a.data.sms ? "" == z && (P = "请进行手机号验证") : 1 == a.data.sms && null == a.data.yz_code && (P = "请进行手机号验证"), 
        "" != P) wx.showModal({
            title: "提示",
            content: P,
            showCancel: !0,
