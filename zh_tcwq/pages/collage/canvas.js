...
Page({
    ...
    onLoad: function(a) {
        ...
        console.log(t, a, i), app.util.request({
            ...
            success: function(t) {
                console.log(t.data), t.data.goods.end_time = util.ormatDate(t.data.goods.end_time), 
                n.setData({
                    url: a.url,
                    QgGoodInfo: t.data.goods
                }), wx.downloadFile({
                    url: a.url + t.data.goods.logo,
                    success: function(t) {
                    ...
                    success: function(t) {
                        console.log(t.data);
                        var e = t.data.store[0], o = a.url + e.logo;
                        app.util.request({
                            ...
                            success: function(t) {
                                console.log(t);
                                var e = t.data;
                                console.log("厂家的logo", o, "小程序码logo1", i + e), wx.downloadFile({
                                    url: o,
                                    success: function(t) {
                                        console.log(t), n.setData({
                                            logo: t.tempFilePath
