...
Page({
        ...
        app.util.request({
            ...
            success: function(t) {
                ...
                o.end_time = n.ormatDate(o.end_time), o.xf_time = n.ormatDate(o.xf_time), app.util.request({
                    ...
                    success: function(t) {
                        console.log("厂家详情", t), n.setData({
                            StoreInfo: t.data.store[0]
                        });
                    }
                }), wx.downloadFile({
                    url: n.data.url + o.logo,
                    success: function(t) {
                        console.log(t.tempFilePath), n.setData({
                            logo: t.tempFilePath
                        }), n.img0();
                    }
                }), wx.downloadFile({
                    url: n.data.url + o.img[0],
                    success: function(t) {
    ...
    onShareAppMessage: function(t) {
        return this.setData({
            ...
            path: "/zh_tcwq/pages/collage/info?id=" + this.data.id,
            success: function(t) {
                console.log(t);
            },
            complete: function(t) {
