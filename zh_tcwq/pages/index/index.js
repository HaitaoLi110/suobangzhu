   ...
   n.marquee_container()
                                ...
                                "" == n && wx.showModal({
                                    ...
                                    success: function(t) {
                                        ...
                                        c.setData({
                                            bkname: e[0].type,
                                            bkarr: e
                                        }), console.log('e555'),console.log(e);
                                    }
                                }), app.util.request({
            ...
            fail: function(t) {
                app.util.request({
                    ...
                    success: function(t) {
                        ...
                        var a = [ "最新信息" ];
                        "1" == t.data.is_sjrz && a.push("热门厂家"), "1" == t.data.is_pageopen && "1" == t.data.is_hyqx && a.push("黄页114"), 
                        ...
                        console.log(n), c.setData({
                            bkarr: a
                        }), c.refresh(), c.seller() ,c.sjbk(),  c.zxbk();
                    }
                });
            }
        }), app.util.request({
    ...
    sjbk: function() {
        ...
        app.util.request({
            ...
            success: function(t) {
				t = t.data;
                for (var e in console.log(t), t.data) t.data[e].distance = '';
	...
	marquee_container:function(){
		var that = this;
		let users= wx.getStorageSync("users");
		let openid =wx.getStorageSync("openid")
		app.util.request({
		    url: "entry/wxapp/indexStore",
		    cachetime: "0",
		    data: {
		        id:users,
		        openid:openid
...
fabu:function(){
    ...
    bkswiperChange: function(t) {
        ...
        console.log(a), "最新信息" == a && e.seller(), "热门厂家" == a && e.sjbk(), "黄页114" == a && e.hybk(), 
        "顺风车" == a && e.sfcbk();
    },
    commend: function(t) {
        var e = this;
	...
	messageBJ: function(t) {
	  
	    var e = t.currentTarget.dataset.id;
		var that= this;
		let user_id = wx.getStorageSync('users').id;
		 app.util.request({
		     url: "entry/wxapp/BjDetails",
		     cachetime: "0",
		     data: {
		         id: e,
		         user_id: user_id
		     ...
		     success: function(res) {
		 		if(res.data.code == '401'){
					...
					wx.navigateTo({
					  url: "../typeP/message_info_price?id=" + e,
					  success: function(e) {},
					  fail: function(e) {},
					  complete: function(e) {}
					});
	...
	sharebtn:function(e){
		...
		let user_id = wx.getStorageSync('users').id;
		app.util.request({
		      url: "entry/wxapp/UserShareBj",
		      data: {
		          user_id: wx.getStorageSync("users").id,
				  bj_id:that.data.sharesID
		      },
		      success: function(e) {
			  }
		});
